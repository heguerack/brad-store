...
## HOME PAGE COMPONENTS AND WRAP UP

- Icon boxes compinet
- Deal Count Down component
- Wrap Up
- Vercel Hobby Plan Error
      ...
      <Card>
        <CardContent className='grid md:grid-cols-4 gap-4 p-4'>
          ...
          <div className='space-y-2'>
            ...
            <div className='text-sm text-muted-foreground'>
              Pay with secure credicard, Paypal or COD
            </div>
          </div>
          <div className='space-y-2'>
            <Headset />
...
- place in in hom,e page `(root)/page.tsx`

### create a DealCountdown component
